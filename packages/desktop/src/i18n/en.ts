export const dict = {
  ...
  "desktop.menu.help.documentation": "MACAW Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of MACAW",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of MACAW has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'macaw' command.",
  ...
  "desktop.cli.error.sidecarMissing": "MACAW CLI binary is missing. Try reinstalling the desktop app.",
