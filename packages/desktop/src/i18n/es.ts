export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de MACAW",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de MACAW. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de MACAW",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de MACAW. Intenta reinstalar la aplicación de escritorio.",
