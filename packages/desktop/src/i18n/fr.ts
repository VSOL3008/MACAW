export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de MACAW",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de MACAW a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'macaw'.",
  ...
  "desktop.menu.help.documentation": "Documentation de MACAW",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI MACAW est manquant. Essayez de réinstaller l'application de bureau.",
