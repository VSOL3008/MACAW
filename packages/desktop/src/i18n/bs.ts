export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju MACAW-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} MACAW-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'macaw'.",
  ...
  "desktop.menu.help.documentation": "MACAW Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka MACAW CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
