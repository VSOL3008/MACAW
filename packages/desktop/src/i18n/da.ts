export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MACAW",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MACAW er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'macaw'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "MACAW CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
