export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MACAW",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MACAW er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "MACAW Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "MACAW CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
