export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 MACAW",
  ...
  "desktop.updater.downloaded.prompt": "已下載 MACAW {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.menu.help.documentation": "MACAW 文件",
  ...
  "desktop.cli.error.sidecarMissing": "MACAW CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
