export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの MACAW を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "MACAW のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'macaw' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "MACAW ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "MACAW CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
