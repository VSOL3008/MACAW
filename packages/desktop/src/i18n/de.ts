export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MACAW",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MACAW wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'macaw' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "MACAW-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das MACAW CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
