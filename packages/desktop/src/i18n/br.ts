export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do MACAW",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do MACAW foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do MACAW",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do MACAW está ausente. Tente reinstalar o aplicativo de desktop.",
