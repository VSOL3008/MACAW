export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию MACAW",
  ...
  "desktop.updater.downloaded.prompt": "Версия MACAW {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'macaw'.",
  ...
  "desktop.menu.help.documentation": "Документация MACAW",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл MACAW CLI. Попробуйте переустановить настольное приложение.",
