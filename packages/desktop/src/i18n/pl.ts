export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji MACAW",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} MACAW. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'macaw'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja MACAW",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego MACAW CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
