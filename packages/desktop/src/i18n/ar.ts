export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من MACAW",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من MACAW، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق MACAW",
  ...
  "desktop.cli.error.sidecarMissing": "ملف MACAW CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
