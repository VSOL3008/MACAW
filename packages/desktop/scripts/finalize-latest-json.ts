...
const releaseId = process.env.MACAW_RELEASE ?? process.env.OPENCODE_RELEASE
if (!releaseId) throw new Error("OPENCODE_RELEASE is required")

const version = process.env.MACAW_VERSION ?? process.env.OPENCODE_VERSION
...
const targets = [
  { key: "linux-x86_64-deb", asset: "macaw-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "macaw-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "macaw-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "macaw-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "macaw-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "macaw-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "macaw-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "macaw-desktop-darwin-aarch64.app.tar.gz",
  },
]
